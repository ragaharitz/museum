  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#koleksiperalatan"><span>Koleksi</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="#koleksiperalatan">Koleksi Sejarah</a></li>
    ...
    <section id="portfolio-details" class="portfolio-details">
      <div class="container">
        ...
        <div class="row gy-4">
<?php foreach ($query as $koleksiperalatan) { } ?>
          <div class="col-lg-4">
            <div class="portfolio-details-slider swiper-container">
              <div class="swiper-wrapper align-items-center">

                <div class="swiper-slide">
                  <img src="<?php echo base_url(); ?>admin/foto/<?php echo $koleksiperalatan['gambar'];?>" alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info" style="margin-right: -10cm;">
              <h3><?php echo $koleksiperalatan['nama_koleksi'];?></h3>
              <ul>
                <li><strong>Kategori</strong>: <?php echo $koleksiperalatan['jenis'];?></li>
                <li><strong>Tahun</strong>: <?php echo $koleksiperalatan['tahun'];?></li>
            ...
            <div class="portfolio-info" style="margin-right: -10cm;">
              ...
              <p><?php echo $koleksiperalatan['deskripsi'];?></p>
